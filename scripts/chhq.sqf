...
switch (toLower typeOf _obj) do {
	...
	case (toLower "B_T_APC_Wheeled_01_cannon_F"): {
	...
	case (toLower "b_apc_tracked_01_rcws_f"): {
	...
	case (toLower "b_apc_wheeled_01_cannon_f"): {
		_composition = [["Land_Portable_generator_F",[-2.4873,2.33643,0.0315285],182.122],["Land_WaterBarrel_F",[3.85596,2,0.0315242],4.92499],["Land_CampingTable_F",[-2.77075,-1.10254,0.031528],276.314],["Land_CampingChair_V1_F",[-3.8562,-0.631348,0.0346532],288.003],["land_cargobox_v1_f",[3.70703,-1.79932,0.0315285],274.286],["b_gmg_01_high_f", [-5, -4.5, -0.1],270],["b_gmg_01_high_f", [5, 4.1, -0.1],90],["b_gmg_01_high_f", [5, -4.5, -0.1],90],["b_gmg_01_high_f", [-5, 4.5, -0.1],270],["land_bagfence_round_f", [-6.75, 4.4, -0.1],90],["land_bagfence_round_f", [6.75, 4.3, -0.1],270],["land_bagfence_round_f", [6.75, -4.4, -0.1],270],["land_bagfence_round_f", [-6.75, -4.4, -0.1],90],["land_hbarrier_5_f", [-6.75, 0, -0.1],90],["land_hbarrier_5_f", [6.75, 0, -0.1],90],["land_hbarrier_5_f", [-4.85, -8.10, -0.1],45],["land_hbarrier_5_f", [4.85, -8, -0.1],-45],["land_hbarrier_5_f", [-3.4, 6.5, -0.1],0],["land_hbarrier_5_f", [4, 6.5, -0.1],0]];
		_cargoInfo = ["land_cargobox_v1_f",[0,-4,.6],0];
		[_obj, _side, _cargoInfo, _composition] call CHHQ_fnc_startingSetup;	
	};
	case (toLower "c_offroad_02_unarmed_f"): {
		_composition = [["Land_Portable_generator_F",[-2.4873,2.33643,0.0315285],182.122],["Land_WaterBarrel_F",[3.85596,0.42627,0.0315242],4.92499],["Land_CampingTable_F",[-2.77075,-1.10254,0.031528],276.314],["Land_CampingChair_V1_F",[-3.8562,-0.631348,0.0346532],288.003],["waterpump_01_forest_F",[4,-3,0.0315285],274.286]];
		_cargoInfo = ["waterpump_01_forest_F",[0,-3.55,-0.32],0];
		[_obj, _side, _cargoInfo, _composition] call CHHQ_fnc_startingSetup;	
	};
	case (toLower "b_heli_light_01_f"): {
		_composition = [["CamoNet_BLUFOR_big_F",[0.0947266,-0.0610352,0.0315285],345.578],["Land_Portable_generator_F",[-2.4873,2.33643,0.0315285],182.122],["Land_WaterBarrel_F",[3.85596,0.42627,0.0315242],4.92499],["Land_CampingTable_F",[-2.77075,-1.10254,0.031528],276.314],["Land_CampingChair_V1_F",[-3.8562,-0.631348,0.0346532],288.003],["land_plasticcase_01_large_f",[4,-3,0.0315285],274.286]];
		_cargoInfo = ["land_plasticcase_01_large_f",[0,-3.55,-0.32],0];
		[_obj, _side, _cargoInfo, _composition] call CHHQ_fnc_startingSetup;	
	};
	default {
		waitUntil {!isNil "CHHQ_HQarray"};
