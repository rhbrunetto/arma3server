...
for "_i" from 1 to 2 do {
	_grp = nil;
	_grp = [ _position, (PO3_side_3 select 0), "EN_PatrolGroup0", 50 ] call PO3_fnc_createGroup;
	if !(isNil "_grp") then {
...
for "_i" from 1 to _b do {
	...
	_grp = nil;
	_grp = [ _ingress, (PO3_side_3 select 0), format["EN_GroupForce_%1",round random 12], 50 ] call PO3_fnc_createGroup;
	if !(isNil "_grp") then {
