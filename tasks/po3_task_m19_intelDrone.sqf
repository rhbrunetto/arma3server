...
// =========================================================================================================
	...
	_randomValue = (round random 6);
	if(_randomValue >= 1) then {
		for "_i" from 0 to (3*PO3_TASK__DIF) do {
			_grp = nil;
			_grp = [ _position, (PO3_side_3 select 0), "EN_PatrolGroup0", 40 ] call PO3_fnc_createGroup;
			if !(isNil "_grp") then {
...
// =========================================================================================================
	...
	_spawnAmbush = {
		...
		for "_i" from 0 to _b do {
			_grp = nil;
			_grp = [ _ingress, (PO3_side_3 select 0), format["EN_GroupForce_%1",round random 8], 50 ] call PO3_fnc_createGroup;
			if !(isNil "_grp") then {
