...
// =========================================================================================================
	...
	_b = (15*(playersNumber(PO3_side_1 select 0)/40)*PO3_TASK__DIF) max 1;
	...
	for "_i" from 1 to 2 do {
		_grp = nil;
		_grp = [ _position, (PO3_side_3 select 0), format["EN_GroupForce_%1",round random 15], 100 ] call PO3_fnc_createGroup;
		if !(isNil "_grp") then {
