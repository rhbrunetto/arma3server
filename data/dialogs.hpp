...
#define PO3CNTRL_38	860038	// Patrol Operations is a gamemode where teamwork and communication is a must have.
...
__EXEC(_loadscreenpicture = ["data\ArmaUnitLogoHuge.JPG","assassin\pics\JoinUsTransparent.JPG"]); // <!-- BON_Inf :D
