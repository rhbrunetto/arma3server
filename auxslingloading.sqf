...
AuxSling_slingSlingableVehicles = 1; //Include vehicles that can be sling loaded with the chopper. e.g. Huron can lift Offroad, you can use this script if set to 1 to
};
if (isNil "AuxSling_EveryVehicles") then {
AuxSling_EveryVehicles = 1; //If AuxSling_Weight = 1, Allow for EVERY VEHICLE/OBJECT to be lifted, ignores AuxSling_x_config
};
...
AuxSling_medium_config = AuxSling_light_config + AuxSling_medium_config + ["APC_Wheeled_01_base_F","APC_Wheeled_02_base_F","APC_Wheeled_03_base_F","Cha_LAV25_base","B_T_AFV_Wheeled_01_cannon_F", "B_T_AFV_Wheeled_01_UP_cannon_F", "O_T_MBT_04_cannon_F","O_T_MBT_04_command_F", "I_LI_01_AT_F","I_LI_01_scout_F","I_LI_01_cannon_F","I_LT_01_AT_F","I_LT_01_scout_F","I_LT_01_cannon_F"]; //lift = 4000 e.g GhostHawk
AuxSling_heavy_config = AuxSling_medium_config + AuxSling_heavy_config + ["APC_Tracked_01_base_F","APC_Tracked_02_base_F","APC_Tracked_03_base_F","MBT_01_base_F","MBT_02_base_F","MBT_03_base_F","Truck_01_base_F","Truck_02_base_F","Truck_03_base_F","Plane_CAS_01_base_F","Plane_CAS_02_base_F","Plane_Fighter_03_base_F","B_MBT_01_TUSK_F","B_APC_Wheeled_01_cannon_F","B_APC_Tracked_01_AA_F", "B_T_AFV_Wheeled_01_cannon_F", "B_T_AFV_Wheeled_01_UP_cannon_F", "O_T_MBT_04_cannon_F","O_T_MBT_04_command_F", "I_LI_01_AT_F","I_LI_01_scout_F","I_LI_01_cannon_F"]; //lift = 10000 e.g. Huron
